...
import com.persistent.medicalmcq.ResultDetailsActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iResultDeatils = new Intent(mContext, ResultDetailsActivity.class);
                iResultDeatils.putExtra("subTopicName", topicName);
                iResultDeatils.putExtra("Color",color );
                iResultDeatils.putExtra("subTopicID", topicID);
                iResultDeatils.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                mContext.getApplicationContext().startActivity(iResultDeatils);
            }
        });
